...
export const TOOLS: ToolMeta[] = [
  ...
  },
  {
    ...
    weaknesses: [
      "紹介制のため、経歴・エリアによって紹介できる求人が限られる場合がある",
      "相談・紹介サービスであり、転職や年収の結果を保証するものではない",
    ],
    verifiedAt: "2026-07-13",
    note: "A8.net 提携済み（programId s00000026573001・detail-partnered 確認 2026-07-13）。成果地点=新規面談設定完了・成果報酬 78,000円・確定率 25.45%・成果確定目安 約45日。affiliateUrl（px.a8.net 計測リンク）を 2026-07-13 に設定。キャリア動線で唯一の計測可能案件（career-company / potepan-camp / ninja-code は未提携のため報酬ゼロ）。",
  },
  {
    id: "techgo",
