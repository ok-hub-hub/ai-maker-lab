...
export const TOOLS: ToolMeta[] = [
  ...
  },
  {
    ...
    // ✅2026-07-30 配線: A8で**既に提携済みだった**（GMOインターネット株式会社・提携日2026/05/12・
    // programId=s00000000018015「【.com/.net ０円〜】独自ドメインの取得は国内シェアNo.1の＜お名前.com＞」）。
    // 報酬=1ドメイン1000円以上:110円／1000円未満:注文金額の11%／移管:1100円／
    // **レンタルサーバー同時申請:3100円**／ドメインセット割:1000円。
    // ⚠️このリンクは **websiteId=001（AImakerLab）専用**。他サイト(002 ココラボ/003 キャリアラウンジ)に
    // 貼ると計測がそのサイトに付かないので、貼る先ごとに広告リンク作成で発行し直す。
    // 経緯: 旧affiliateUrl(ValueCommerceのwaadトークン直リンク)は保有しておらず同日に除去。その時点では
    // 「未提携＝要申請」と判断していたが、A8の参加中プログラムを実機で確認したら提携済みだった
    // （＝14記事44箇所が提携済みのまま1円も計上されていなかった。申請も審査待ちも不要）。
    affiliateUrl: "https://px.a8.net/svt/ejp?a8mat=4B3OQZ+CKHGJ6+50+2HHVNM",
    description:
  ...
  },
  {
    ...
    note: "A8.net 提携申請（2026-06-18）は **2026-08-03 に審査却下を確認**（申込中一覧から消失・detail-not-partnered・申請中バッジなし）。オーナー承認(Q-073=A案)により記事4本の掲載を type-tenshoku（もしも・提携済¥11,000）へ差し替え済み＝**現在このエントリを使う記事は無い**。再申請はオーナー承認が無い限り行わない（ブラックリスト対策方針）。",
  },
  {
    id: "meiko-career",
    ...
    scale: 2,
    affiliateTier: "S",
    officialUrl: "https://meiko-career.jp/lp3/engineer/",
    affiliateUrl: "https://px.a8.net/svt/ejp?a8mat=4B7U10+CU0E7M+5P1E+5YRHE",
    serviceType: "agent",
    conversionPoint: "free-counseling",
    payoutJpy: 78000,
    description:
    ...
    strengths: [
      ...
      "まずは面談（キャリア相談）から始められるため、応募前に方向性を確認できる",
    ],
    weaknesses: [
      "A8成果条件は「エンジニア実務経験者・東京大阪エリア就職希望」のみ（地方在住・完全未経験は成果不成立の可能性あり）",
      "相談・紹介サービスであり、転職や年収の結果を保証するものではない",
    ],
    verifiedAt: "2026-07-13",
    note: "A8.net 提携済み（programId s00000026573001・detail-partnered 確認 2026-07-13）。成果地点=新規面談設定完了・成果報酬 78,000円・確定率 25.45%・成果確定目安 約45日。affiliateUrl（px.a8.net 計測リンク）を 2026-07-13 に設定。キャリア動線で唯一の計測可能案件（career-company / potepan-camp / ninja-code は未提携のため報酬ゼロ）。【D-152 2026-09-11 一次実読】A8成果条件の詳細：広告主新規・WEB申込後30日以内面談設定完了・エンジニア経験者・東京大阪エリア以外就職希望は否認。公式LPは経験者事例中心。",
  },
  {
    id: "techgo",
    name: "TechGo（ITエンジニアのハイクラス転職）",
    category: ["career"],
    forEngineer: true,
    forBeginner: false,
    priceMin: 0,
    ...
    strengths: [
      ...
      "ITエンジニア経験者のハイクラス・上流転職に特化",
      "まずは面談（キャリア相談）から始められる",
    ],
    weaknesses: [
      "経験者向けのため、実務未経験者には求人紹介が限られる場合がある（未経験は明光キャリアパートナーズが適合）",
      "相談・紹介サービスであり、転職や年収の結果を保証するものではない",
    ],
  ...
  },
  {
    ...
    scale: 2,
    affiliateTier: "S",
    officialUrl: "https://makers-job.jp/",
    affiliateUrl: "https://px.a8.net/svt/ejp?a8mat=4BAE5G+8D9CVM+5B0Y+TRVYQ",
    serviceType: "agent",
    conversionPoint: "free-counseling",
    payoutJpy: 50000,
    description:
      "メーカー・製造業に特化した転職エージェント。求職者は無料で、製造・生産技術・品質管理・設計などの職種に詳しいコンサルタントに相談できる。無料面談から始められる。",
    strengths: [
      "求職者は無料で利用できる（採用企業側から報酬を得るモデル）",
      "メーカー・製造業という業界に絞ったエージェントで、業界事情に明るい担当が付く",
      "まずは無料面談から始められる",
    ],
    weaknesses: [
      "業界特化のため、IT・Web業界のみを志望する場合は総合型や IT特化型の方が求人数で有利",
      "相談・紹介サービスであり、転職や年収の結果を保証するものではない",
    ],
    verifiedAt: "2026-08-29",
    note: "A8.net 提携済み（programId s00000024757005・2026-08-25 申請→同日承認・参加中プログラムの提携日2026/08/25で確認）。掲載サイト=AImakerLab（websiteId 001・a8mat のサイトセグメント 8D9CVM）。**この提携はAImakerLab枠なので careerlounge / ココラボには掲載できない**（掲載する場合は各サイトで別途提携申請が必要）。成果報酬は通常18,000円のところキャンペーンで50,000円（2026/08/15〜2026/09/30）。さらにテーブル制特単（計測 2026/08/15〜09/30・適用 2026/10/08〜）で 1〜3件=50,000円・4〜6件=75,000円・7件〜=100,000円。TechGo（同じMyVision運営）の同額キャンペーンは2026/08/31で終了するため、9月以降の¥50,000枠はこちらが本命。リンクは 2026-08-29 に実接続検証済み（302→form.makers-job.jp・a8トラッキング付与を確認）。受け皿記事はまだ無い。",
  },
  {
    id: "type-tenshoku",
    name: "type転職エージェント",
  ...
  },
  {
    ...
    //（請求書買取＝ファクタリング）。診断は category.includes(q1) で絞るため、
    // カテゴリを付けると「AIツールを探しに来た人」に金融サービスを推薦してしまう。
    // 空配列なら診断にもツール一覧にも出ず、/go/labol の計測リンクだけが生きる。
    category: [],
    forEngineer: true,
    forBeginner: true,
    // 会員登録・利用開始そのものは無料。手数料は買取額に対して発生する（下記 weaknesses に明記）
    priceMin: 0,
    priceFree: true,
    jpFriendly: true,
    speed: 3,
    ...
    // A8テキストリンク素材「フリーランス・個人事業主限定の請求書買取サービス「labol（ラボル）」」
    // （programId s00000018733008 / create-link から 2026-07-28 取得）
    affiliateUrl: "https://px.a8.net/svt/ejp?a8mat=4B7VL2+CMV6YA+40JM+1BQYPU",
    serviceType: "freelance",
    conversionPoint: "free-signup",
    payoutJpy: 3000,
    description:
      "フリーランス・個人事業主向けの請求書買取（ファクタリング）サービス。取引先からの入金を待たずに、発行済みの請求書を売却して先に現金化できる。1万円から利用でき、手数料は買取額の一律10%。審査通過後は最短30分で振込（※審査状況・申込時間帯による）。借入ではなく債権の売却なので、信用情報への照会は行われない。",
    strengths: [
      "1万円から必要な額だけ使える（全額を現金化する必要がない）",
      "手数料が買取額の一律10%で、振込手数料などの追加費用がかからない（2026-07-28 公式確認）",
      "審査は信用情報に照会しない独自審査。Web完結で、審査通過後は最短30分で振込（※条件あり）",
      "原則として取引先に知られずに利用できる",
    ],
    weaknesses: [
      "**手数料10%は安くない**。支払サイト30日の請求書を現金化する場合、負担は年利換算で100%を超える水準に相当する。常用するとキャッシュフローがむしろ悪化する",
      "資金繰りの構造的な問題（単価が低い・支払サイトが長い・入金遅延が常態化）は解決しない。値上げや取引条件の見直しが本筋",
      "審査があるため、請求書の内容や取引先によっては利用できない場合がある",
    ],
    verifiedAt: "2026-07-28",
    note: "A8.net 提携済み（提携日 2026-07-08・成果地点=新規会員登録・成果報酬 3,000円・確定率 94.52%・EPC 1,361）。手持ちで最も成約しやすい導線だが、金融サービスのため誇張表現を置かないこと（融資・借入と書かない／「審査に落ちても借りられる」等の煽り禁止／最短30分は必ず※条件を併記）。2026-07-28 公式サイトで手数料一律10%・1万円〜・最短30分・信用情報非照会を実接続で確認。",
  },
  {
    id: "paytner",
    name: "ペイトナー ファクタリング",
    // labol と同じ理由で category は空にする（AIツールではなく資金調達サービス。
    // 診断・ツール一覧に出さず、/go/paytner の計測リンクだけを生かす）
    category: [],
    forEngineer: true,
    forBeginner: true,
    priceMin: 0,
    ...
    scale: 2,
    affiliateTier: "S",
    officialUrl: "https://paytner.co.jp/",
    // A8テキストリンク素材「フリーランス向け報酬即日払いサービス【ペイトナー】」
    // programId s00000021957001 / create-link から 2026-08-29 取得。
    // 掲載サイトのselectが「AImakerLab【アピールサイト】」であることを画面で確認済み。
    affiliateUrl: "https://px.a8.net/svt/ejp?a8mat=4BAE5G+8G8IWI+4PF6+5YJRM",
    serviceType: "freelance",
    conversionPoint: "free-signup",
    payoutJpy: 3000,
    description:
      "フリーランス・個人事業主向けの請求書買取（ファクタリング）サービス。発行済みの請求書を売却して、取引先の入金を待たずに現金化できる。1万円から必要な額だけ利用でき、手数料は一律10%。審査は面談不要のオンライン完結で、土日祝を含めて振込に対応している。",
    strengths: [
      "1万円から必要な額だけ利用できる（請求書の全額を現金化する必要がない）",
      "手数料が一律10%（2026-08-29 公式サイトで確認）",
      "面談不要・オンライン完結で、土日祝を含む振込に対応（※審査状況・申込時間帯による）",
    ],
    weaknesses: [
      "手数料10%は年利換算ではなく1回あたりの率。支払サイトが短い請求書ほど実質負担は重くなる",
      "審査があるため、請求書の内容や取引先によっては利用できない場合がある",
      "当編集部では未利用のため、審査の通りやすさ・振込までの実時間は未検証（公式情報ベース）",
    ],
    verifiedAt: "2026-08-29",
    note: "A8.net 提携済み（提携日 2026-08-26・programId s00000021957001・成果地点=新規ユーザー登録・成果報酬 3,000円・確定率 59.85%・EPC 767.7）。labol と同カテゴリで条件もほぼ同等（どちらも手数料一律10%・1万円〜）のため、記事では優劣を断定せず併記して読者に選ばせること。金融サービスにつき誇張表現禁止（融資・借入と書かない／「必ず通る」等の煽り禁止／振込スピードには必ず※条件を併記）。2026-08-29 公式サイトを実接続で確認。編集部未利用のため体験談は書かない。",
  },
];
