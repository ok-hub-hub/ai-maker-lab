...
前回の[【AI会社運営 Day14】記事](/posts/affiliate-2weeks-zero-to-video-pivot-2026/) で、アフィリエイト 2 週間流入ゼロから「動画ニッチ並走」に新規軸を投入した話を書きました。今回はその続編── **新規ブランド「ナゾラボ」のハンドル `@nazo_lab` を 3 プラで取得するまで、Playwright で実検証した記録** です。

> **連載J3「売る実験ログ」第2話**：[J3-01](/posts/affiliate-2weeks-zero-to-video-pivot-2026/) の続き。AI Maker Lab の新規収益軸 [ナゾラボ（@nazo_lab）](#) 立ち上げ実況の Week 2。
...
| YouTube | `create_channel` トークン直接叩き | Google アカウント個人名「山田有志」が自動採用、確認モーダルなしで作成 |
...
- 個人 Google でチャンネル作ると「本名」がチャンネル名として残る（必ず別 Google アカウント or ブランドアカウント）

## 次回予告

来週（2026-06-16）は **J3-03「初投稿7本のデータ全公開」** を予定。

- 投稿1本目「信長×iPhone」の 24h/48h/7日 再生数・フォロワー・送客
- 何が当たって、何がダダ滑りしたのか
- 計測ダッシュボード（Google Sheets）の構造公開
...
- [J3-01：アフィリエイト2週間で流入ゼロ、だから動画ニッチに賭ける](/posts/affiliate-2weeks-zero-to-video-pivot-2026/)
- **J3-02：ハンドル取得競争 Playwright 検証**（本記事）
...
- [v0 vs Lovable vs Bolt 比較 2026](/posts/v0-vs-lovable-vs-bolt-2026/)
