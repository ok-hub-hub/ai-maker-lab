...
## 2026年8月・Sonnet 5 イントロ価格終了（8/31）前の最終判断

2026年8月現在、Claude Sonnet 5 には**イントロ価格 $2/$10/MTok** が適用されています。しかし **2026年8月31日で終了**し、通常価格 $3/$15/MTok に移行します。この価格シフトは「Sonnet 5 vs GPT-5.6 Luna どちらを選ぶか」の答えを変えます。

### 8月末前後で選択肢がどう変わるか

| 時期 | Claude Sonnet 5 | GPT-5.6 Luna | Sonnet 5 / Luna 差 | 記事1本（入力1k+出力2k tok）の差 |
|------|-----------------|--------------|-------------------|-------------------------------|
| 〜2026/8/31（イントロ） | $2.00/$10.00 | $1.00/$6.00 | **約1.7倍** | 約$0.009（≈1.4円） |
| 2026/9/1〜（通常） | $3.00/$15.00 | $1.00/$6.00 | **約3倍** | 約$0.018（≈2.7円） |

*料金は Anthropic 公式ドキュメント（2026-07-15 実取得）の情報にもとづきます。9月以降は必ず公式で最新価格を確認してください。*

8月中は Sonnet 5 が GPT-5.6 Terra（$2.50/$15）より安く、Luna との差も小さい。9月以降は **Sonnet 5 が Terra と同水準**に上がるため、「低コスト量産で Sonnet 5 を選ぶ理由」が弱まります。

### 8月中に決めておく3点

1. **量産ワークフローの月コストを今計測する**：9月以降と比べるベースラインになる
2. **9月以降の代替方針を決める**：下書きを Luna で量産して人が仕上げる、または [Catchy](/go/catchy)・[Transcope](/go/transcope) でモデル選択を抽象化する
3. **使用量が月1,000本を超えるなら特に注意**：価格差がそのままコストに響く規模になる

イントロ価格終了後は「API 直接利用の Sonnet 5 で量産」の優位が縮まります。日本語SEO記事を継続量産するなら、8月末をきっかけにツール選択を見直す価値があります。
...
関連比較：[claude opus 4.8 gpt5.5 の日本語ライティング比較](/posts/claude-sonnet5-vs-opus48-vs-gpt55-jp-writing-2026/) — Sonnet 5 も含む3モデルのコスパ比較はこちら。
